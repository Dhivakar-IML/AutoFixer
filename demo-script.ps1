...
# Main demo script
Write-Header "[START] AutoFixer - Intelligent Error Pattern Detection Demo"
...
if ($patterns -and $patterns.Count -gt 0) {
    ...
    if ($patternDetailResponse -and $Detailed) {
        ...
        Write-Host "`n   📊 Pattern Details:" -ForegroundColor Magenta
...
if ($alertsResponse) {
    ...
    if ($alerts -and $alerts.Count -gt 0) {
        Write-Host "`n   🔔 Active Alerts:" -ForegroundColor Magenta
        Write-Host "   " + "-" * 40 -ForegroundColor Gray
...
if ($overviewResponse) {
    ...
    if ($overview) {
        Write-Host "`n   📊 System Overview:" -ForegroundColor Magenta
        Write-Host "   " + "-" * 40 -ForegroundColor Gray
...
Write-Host "`n   🧠 ML Engine Capabilities:" -ForegroundColor Magenta
Write-Host "   " + "-" * 50 -ForegroundColor Gray
Write-Host "   ✅ TF-IDF Text Featurization for error message analysis" -ForegroundColor Green
Write-Host "   ✅ DBSCAN Clustering for grouping similar errors" -ForegroundColor Green  
Write-Host "   ✅ Cosine Similarity for pattern matching" -ForegroundColor Green
Write-Host "   ✅ Confidence Scoring for pattern reliability" -ForegroundColor Green
Write-Host "   ✅ Anomaly Detection for unusual error patterns" -ForegroundColor Green
Write-Host "   ✅ Trend Analysis for pattern evolution tracking" -ForegroundColor Green
...
Write-Host "`n   🎯 AutoFixer Key Features Demonstrated:" -ForegroundColor Magenta
Write-Host "   " + "-" * 50 -ForegroundColor Gray
Write-Host "   ✅ Intelligent Error Pattern Detection" -ForegroundColor Green
Write-Host "   ✅ Machine Learning-Powered Clustering" -ForegroundColor Green
Write-Host "   ✅ Real-time Alert Management" -ForegroundColor Green
Write-Host "   ✅ Advanced Filtering and Analytics" -ForegroundColor Green
Write-Host "   ✅ RESTful API with Swagger Documentation" -ForegroundColor Green
Write-Host "   ✅ MongoDB Integration for Scalable Storage" -ForegroundColor Green
Write-Host "   ✅ Multi-channel Notification Support" -ForegroundColor Green
